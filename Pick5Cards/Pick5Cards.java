/*
 * PE 15-1 Pick5Cards
 * Write a program that displays five cards from a deck of 52 cards,
 * similar to the figure below.
 * Add a Refresh button to display a "new hand" when clicked. 
 * (HINT: Programming Exercise 14.3 has some tips on obtaining and 
...
public class  Pick5Cards extends Application {
