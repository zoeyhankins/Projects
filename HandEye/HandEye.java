/*
 * PE 15-2 HandEye
 * Write a program that displays a circle of radius 10 pixels 
 * filled with a random color at a random location on a pane.
 * 
 * When you click the circle, it disappears and a new random-color 
 * circle is displayed at another random location. 
 * After 10 circles are clicked, display the time spent in the pane.
 * 
 */
